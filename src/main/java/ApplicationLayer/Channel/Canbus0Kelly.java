...
public class Canbus0Kelly extends Channel {
     ...
     */
    public Canbus0Kelly(List<AppComponent> myComponentList, List<Service> myServices, boolean dev) {
    ...
    public void parseMessage(String message) {
        ...
        switch (s){
            case "100":
                ...
                this.sevcon.valoresRealesActuales[5] = Double.parseDouble(msg[3].split(":")[1]); //temp inv
            ...
            case "200":
                ...
                this.sevcon.valoresRealesActuales[2] = Double.parseDouble(msg[4].split(":")[1]); // rpm
                this.sevcon.valoresRealesActuales[0] = Double.parseDouble(msg[1].split(":")[1]);// corriente motor
                this.sevcon.valoresRealesActuales[7] = Double.parseDouble(msg[5].split(":")[1]); // potout
                this.sevcon.valoresRealesActuales[13] = Double.parseDouble(msg[3].split(":")[1]); // velocidad
            ...
            case "300":
                ...
                this.sevcon.valoresRealesActuales[15] = Double.parseDouble(msg[4].split(":")[1]); // target lq_hex
                this.sevcon.valoresRealesActuales[12] = Double.parseDouble(msg[2].split(":")[1]); // lq
                this.sevcon.valoresRealesActuales[14] = Double.parseDouble(msg[5].split(":")[1]); // lq_hex
                break;
            case "400":
            ...
            case "101":
                this.sevcon.valoresRealesActuales[0] = Double.parseDouble(msg[2].split(":")[1]);//v bat
                this.sevcon.valoresRealesActuales[1] = Double.parseDouble(msg[1].split(":")[1]); // current bat
                this.sevcon.valoresRealesActuales[21] = Double.parseDouble(msg[3].split(":")[1]); //temp inv
                this.sevcon.valoresRealesActuales[6] = Double.parseDouble(msg[4].split(":")[1]); // potin
                break;
            case "201":
                //'COB_ID:'+str(cod_id)+','+'motorC:'+str(motor_C)+','+'torque:'+str(motor_torque)+','+'KM/H:'+str(2*3.6*np.pi*0.3*RPM/60)+','+'RPM:'+str(RPM)+','+'POUT:'+str(motor_torque*RPM*2*np.pi/60)+'\n'
                this.sevcon.valoresRealesActuales[3] = Double.parseDouble(msg[2].split(":")[1]); // torque
                this.sevcon.valoresRealesActuales[18] = Double.parseDouble(msg[4].split(":")[1]); // rpm
